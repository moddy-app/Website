          ...
          <div className="content-wrapper">
            ...
            {isEnglish && (
              <div className="content-en active">
                ...
                <p className="subtitle">
                  ...
                  Moddy is in development and will be available soon.
                </p>
              </div>
            )}
            ...
            {!isEnglish && (
              <div className="content-fr active">
                ...
                <p className="subtitle">
                  Ce site est actuellement en cours de construction.<br />
                  Moddy est en développement et sera bientôt disponible.
                </p>
              </div>
            )}
            ...
            <div className="buttons">
              <md-filled-button
                ...
                style={{
                  '--md-filled-button-container-color': '#202020',
                  '--md-filled-button-label-text-color': '#ffffff',
                }}
              >
                <svg slot="icon" viewBox="0 0 24 24" aria-hidden="true" width="18" height="18">
                ...
                <span className="btn-text">
                  {isEnglish ? 'Support Server' : 'Serveur Support'}
                </span>
              </md-filled-button>
